      ...
      bottom: PreferredSize(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              // Orqaga tugmasi
              if (_level != _DrillLevel.district)
                IconButton(
                  onPressed: () {
                    setState(() {
                      switch (_level) {
                ...
                child: ListView(
                  ...
                  children: [
                    _buildBreadcrumbItem(
                      'Hududlar',
                      _DrillLevel.district,
                      _level == _DrillLevel.district,
                    ),
                    if (_level.index >= _DrillLevel.mfy.index &&
                        _selDistrict != null)
                      _buildBreadcrumbItem(
                        _selDistrict!,
                        _DrillLevel.mfy,
                    ...
                    if (_level.index >= _DrillLevel.street.index &&
                        _selMfy != null)
                      _buildBreadcrumbItem(
                        _selMfy!,
                        _DrillLevel.street,
                    ...
                    if (_level.index >= _DrillLevel.household.index &&
                        _selStreet != null)
                      _buildBreadcrumbItem(
                        _selStreet!,
                        _DrillLevel.household,
    ...
    return Container(
      ...
      child: GestureDetector(
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => SurveyorSearchPage(households: _all),
          ),
        ),
        child: Container(
          height: 48,
